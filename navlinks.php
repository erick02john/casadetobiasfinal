		...
		<div class="container">
			<nav class="navbar navbar-default">
				<div class="navbar-header navbar-left">
					...
					<h1><a class="navbar-brand" href="index.php">Casa de <span>Tobias</span><p class="logo_w3l_agile_caption">Mouintain Resort</p></a></h1>
				</div>
              ...
              <li <?=(($base == ''.base_url().'contactus.php') ? 'class="menu__item menu__item--current"':"class='menu__item'")?>><a href="newreservation/step1.php" class="menu__link">Book Now</a></li>
						</ul>
					</nav>
				</div>
			</nav>
