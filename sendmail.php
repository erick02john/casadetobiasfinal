...
try {
    ...
    $mail->addAddress(''.$result1['Email'].'', 'tumulong ka na kailangan ka na namin boy');     // Add a recipient
    ...
    Thank you for making a reservation with us, Please upload here your bank deposit slip ('.base_url().'depositupload?id='.$_GET['mailids'].') for verification purposes. We hope to see you on your scheduled date, have a great day!
