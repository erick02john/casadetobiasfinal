  ...
  <section class="invoice">
    ...
    <div class="row invoice-info">
      <div class="col-sm-4 invoice-col">
        ...
        <address>
          ...
          Email: casadetobiasmountainresort@gmail.com
        </address>
      </div>
      <!-- /.col -->
      <div class="col-sm-4 invoice-col">
      ...
      <div class="col-sm-4 invoice-col">
        ...
        if($payment == 'Cash'){
          ...
          Account Name : Casa de Tobias<br />
    ...
    if($payment == 'Cash'){
      ...
      <form enctype="multipart/form-data" method="POST">
        <input type="file" name="uploaded_file" style="color:white;"></input><br />
        <button type="submit" id="uploadfiles">Upload</button>
      </form>
      <?php
    }
    ?>
...
<?php
  if(!empty($_FILES['uploaded_file']))
  {
    ...
    if(move_uploaded_file($_FILES['uploaded_file']['tmp_name'], $path)) {
      ...
      $data = array(
      	'depositimg' => $_FILES['uploaded_file']['name'],
        'stat' => 3
      );


      douploadfiles($_GET['id'],$data);
    } else{
