        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
					...
					<li>
                        <a   href="walkinreservation.php"><i class="fa fa-bar-chart-o"></i> Reservation</a>
                    </li>
                    ...
                    <li>
                        <a  c href="room.number.php"><i class="fa fa-qrcode"></i> Rooms</a>
                    </li>
                    <li>
                        <a   href="report.php"><i class="fa fa-qrcode"></i> Report</a>
                    </li>
                    <li>
