   ...
   $id = $_GET['id'];
    ...
    $result = $con->query($sql);
        while($row=$result->fetch_assoc()){
            ...
            $query = mysqli_query($sql1, $connection) or die ("Database Connection Failed");
                    ...
                    <div class="col-sm-9 col-sm-offset-0">
                        ...
                        <div class="wizard-container">
                            <div class="card wizard-card" data-color="rose" id="wizardProfile">
                                <form action="<?=base_url()?>admin/reservation/invoice.php" method="GET">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="input-group">
                                                        ...
                                                        <div class="form-group label-floating">
                                                            <label class="control-label">Room Type</label>
                                                           <input name="roomtype" type="text" class="form-control" value="<?=$roomtype?>" readonly>
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="input-group">
                                                        ...
                                                        <div class="form-group label-floating">
                                                            <label class="control-label">Room Price</label>
                                                            <input name="roomprice" type="text" class="form-control"  value="<?=$roomprice?>" readonly>
                                                        </div>
                                                    </div>
                                                    <div class="input-group">
                                                        <span class="input-group-addon">
                                                        ...
                                                        <div class="form-group label-floating">
                                                            <label class="control-label">Room Capacity</label>
                                                            <input name="roomcapacity" type="text" class="form-control"  value="<?=$roomcapacity?>" readonly>
                                                        </div>
                                                    </div>
                                                    <div class="input-group">
                                                        <span class="input-group-addon">
                                                        ...
                                                        <div class="form-group label-floating">
                                                            <label class="control-label">Room Availability</label>
                                                            <input name="roomavailable" type="text" class="form-control"  value="<?=(($roomavailable > 0) ? 'Available':'Not Available')?>" readonly>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-sm-5">
                                                ...
                                                <div class="col-sm-6">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <div class="form-group label-floating">
                                                            ...
                                                            <input type="text"  name="phonenumber" class="form-control" onfocus="this.select()" onkeypress="return isNumberKey(event)" style="width: 190px;" maxlength="11" REQUIRED>
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="wizard-footer">
                                        <div class="pull-right">
                                            <a href="<?=base_url()?>admin/home.php" class='btn btn-rose'>BACK</a>
...
<script type="text/javascript">
    ...
    $('#roomtype').change(function(e) {  
            ...
            if (srch1.length > 0 || srch1.length == 0) {
                 ...
                 $.ajax({
                        type:'POST',
                        url:'<?php echo base_url(); ?>admin/reservation/replace2.php',
                        data: {srch1: srch1},
                        success:function(data){
                            $('#replace2').html(data);
                        }
