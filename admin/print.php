...
@page { margin: 0; }
	...
	?>
		<header>
			<h1>Invoice</h1>
			<address >
				<p>Casa de Tobias Mountain Resort</p>
				<p>Alibungbungan,<br>Nagcarlan,<br>Laguna</p>
				<p>(02) 794 3471</p>
			</address>
		...
		<aside>
			...
			<div >
				<p align="center">Email : casadetobias@gmail.com || Phone :(02) 794 3471 </p>
			</div>
		</aside>
	</body>
</html>
...
$free="Free";
$nul = null;
$rpsql = "UPDATE `room` SET `status`='$free',`cusid`='$nul' where `cusid`='$id'";
